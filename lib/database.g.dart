...
class $QuestionsTable extends Questions
  ...
  static const VerificationMeta _examNameMeta =
      const VerificationMeta('examName');
  @override
  late final GeneratedColumn<String> examName = GeneratedColumn<String>(
      'exam_name', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  late final GeneratedColumn<String> difficulty = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _questionLatexMeta =
      const VerificationMeta('questionLatex');
  @override
  late final GeneratedColumn<String> questionLatex = GeneratedColumn<String>(
      'question_latex', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _questionSvgMeta =
      const VerificationMeta('questionSvg');
  @override
  late final GeneratedColumn<String> questionSvg = GeneratedColumn<String>(
      'question_svg', aliasedName, true,
  ...
  late final GeneratedColumn<String> optionsJson = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _answerKeyMeta =
      const VerificationMeta('answerKey');
  @override
  late final GeneratedColumn<String> answerKey = GeneratedColumn<String>(
      'answer_key', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  late final GeneratedColumn<String> solution = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _solutionSvgMeta =
      const VerificationMeta('solutionSvg');
  @override
  late final GeneratedColumn<String> solutionSvg = GeneratedColumn<String>(
      'solution_svg', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  @override
  ...
  VerificationContext validateIntegrity(Insertable<Question> instance,
    ...
    if (data.containsKey('question_latex')) {
      context.handle(
          ...
          questionLatex.isAcceptableOrUnknown(
              data['question_latex']!, _questionLatexMeta));
    } else if (isInserting) {
    ...
    if (data.containsKey('question_svg')) {
      context.handle(
          ...
          questionSvg.isAcceptableOrUnknown(
              data['question_svg']!, _questionSvgMeta));
    }
    ...
    if (data.containsKey('solution_svg')) {
      context.handle(
          _solutionSvgMeta,
          solutionSvg.isAcceptableOrUnknown(
              data['solution_svg']!, _solutionSvgMeta));
    }
    return context;
  }
  ...
  Question map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Question(
      ...
      examName: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}exam_name'])!,
      ...
      questionLatex: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}question_latex'])!,
      questionSvg: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}question_svg']),
      optionsJson: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}options_json'])!,
      answerKey: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}answer_key']),
      solution: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}solution']),
      solutionSvg: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}solution_svg']),
    );
  }
...
class Question extends DataClass implements Insertable<Question> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || solutionSvg != null) {
      map['solution_svg'] = Variable<String>(solutionSvg);
    }
    return map;
  }
  ...
  QuestionsCompanion toCompanion(bool nullToAbsent) {
    return QuestionsCompanion(
      ...
      solution: solution == null && nullToAbsent
          ? const Value.absent()
          : Value(solution),
      solutionSvg: solutionSvg == null && nullToAbsent
          ? const Value.absent()
          : Value(solutionSvg),
    );
  }
  ...
  factory Question.fromJson(Map<String, dynamic> json,
    ...
    return Question(
      ...
      solutionSvg: serializer.fromJson<String?>(json['solutionSvg']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'solutionSvg': serializer.toJson<String?>(solutionSvg),
    };
  }
  ...
  Question copyWith(
          ...
          Value<String?> solutionSvg = const Value.absent()}) =>
      Question(
        id: id ?? this.id,
        ...
        solutionSvg: solutionSvg.present ? solutionSvg.value : this.solutionSvg,
      );
  Question copyWithCompanion(QuestionsCompanion data) {
    return Question(
      ...
      questionLatex: data.questionLatex.present
          ...
          : this.questionLatex,
      questionSvg:
          data.questionSvg.present ? data.questionSvg.value : this.questionSvg,
      optionsJson:
      ...
      solutionSvg:
          data.solutionSvg.present ? data.solutionSvg.value : this.solutionSvg,
    );
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is Question &&
          ...
          other.solutionSvg == this.solutionSvg);
}
...
class QuestionsCompanion extends UpdateCompanion<Question> {
  ...
  final Value<String?> solutionSvg;
  ...
  const QuestionsCompanion({
    ...
    this.solutionSvg = const Value.absent(),
  ...
  static Insertable<Question> custom({
    ...
    return RawValuesInsertable({
      ...
      if (solutionSvg != null) 'solution_svg': solutionSvg,
  ...
  QuestionsCompanion copyWith(
    ...
    return QuestionsCompanion(
      ...
      solutionSvg: solutionSvg ?? this.solutionSvg,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (solutionSvg.present) {
      map['solution_svg'] = Variable<String>(solutionSvg.value);
    }
    if (rowid.present) {
...
class PracticeSession extends DataClass implements Insertable<PracticeSession> {
  ...
  @override
  int get hashCode => Object.hash(id, startTime, durationSeconds,
...
class $SessionAnswersTable extends SessionAnswers
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, sessionId, questionId, selectedOption, isCorrect, timeSpent];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final Index questionsIndex = Index('questions_index',
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [questions, practiceSessions, sessionAnswers, mistakes, questionsIndex];
}
...
final class $$QuestionsTableReferences
  ...
  static MultiTypedResultKey<$MistakesTable, List<Mistake>> _mistakesRefsTable(
      ...
      MultiTypedResultKey.fromTable(db.mistakes,
          aliasName:
              $_aliasNameGenerator(db.questions.id, db.mistakes.questionId));
...
class $$QuestionsTableFilterComposer
  ...
  ColumnFilters<String> get examName => $composableBuilder(
      column: $table.examName, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<String> get questionLatex => $composableBuilder(
      column: $table.questionLatex, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get questionSvg => $composableBuilder(
      column: $table.questionSvg, builder: (column) => ColumnFilters(column));
  ...
  ColumnFilters<String> get answerKey => $composableBuilder(
      column: $table.answerKey, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get solution => $composableBuilder(
      column: $table.solution, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get solutionSvg => $composableBuilder(
      column: $table.solutionSvg, builder: (column) => ColumnFilters(column));
...
class $$QuestionsTableOrderingComposer
  ...
  ColumnOrderings<String> get examName => $composableBuilder(
      column: $table.examName, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get questionSvg => $composableBuilder(
      column: $table.questionSvg, builder: (column) => ColumnOrderings(column));
  ...
  ColumnOrderings<String> get answerKey => $composableBuilder(
      column: $table.answerKey, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get solution => $composableBuilder(
      column: $table.solution, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get solutionSvg => $composableBuilder(
      column: $table.solutionSvg, builder: (column) => ColumnOrderings(column));
}
...
class $$QuestionsTableAnnotationComposer
  ...
  GeneratedColumn<String> get questionLatex => $composableBuilder(
      column: $table.questionLatex, builder: (column) => column);

  GeneratedColumn<String> get questionSvg => $composableBuilder(
      column: $table.questionSvg, builder: (column) => column);
  ...
  GeneratedColumn<String> get solutionSvg => $composableBuilder(
      column: $table.solutionSvg, builder: (column) => column);
                ...
                return [
                  if (mistakesRefs)
                    await $_getPrefetchedData<Question, $QuestionsTable,
                        ...
                        currentTable: table,
                        referencedTable:
                            $$QuestionsTableReferences._mistakesRefsTable(db),
...
final class $$PracticeSessionsTableReferences extends BaseReferences<
    _$AppDatabase, $PracticeSessionsTable, PracticeSession> {
  $$PracticeSessionsTableReferences(
      super.$_db, super.$_table, super.$_typedResult);

  static MultiTypedResultKey<$SessionAnswersTable, List<SessionAnswer>>
      _sessionAnswersRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.sessionAnswers,
              aliasName: $_aliasNameGenerator(
                  db.practiceSessions.id, db.sessionAnswers.sessionId));

  $$SessionAnswersTableProcessedTableManager get sessionAnswersRefs {
    final manager = $$SessionAnswersTableTableManager($_db, $_db.sessionAnswers)
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (sessionAnswersRefs)
                    await $_getPrefetchedData<PracticeSession,
                            $PracticeSessionsTable, SessionAnswer>(
                        currentTable: table,
                        referencedTable: $$PracticeSessionsTableReferences
                            ._sessionAnswersRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$PracticeSessionsTableReferences(db, table, p0)
                                .sessionAnswersRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
...
final class $$SessionAnswersTableReferences
  ...
  static $PracticeSessionsTable _sessionIdTable(_$AppDatabase db) =>
      db.practiceSessions.createAlias($_aliasNameGenerator(
          db.sessionAnswers.sessionId, db.practiceSessions.id));
              ...
              addJoins: <
                ...
                if (sessionId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$SessionAnswersTableReferences._sessionIdTable(db),
                    referencedColumn:
                        $$SessionAnswersTableReferences._sessionIdTable(db).id,
                  ) as T;
                }
              ...
              addJoins: <
                ...
                if (questionId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$MistakesTableReferences._questionIdTable(db),
                    referencedColumn:
                        $$MistakesTableReferences._questionIdTable(db).id,
                  ) as T;
                }
